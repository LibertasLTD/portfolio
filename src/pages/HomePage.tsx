...
export default function HomePage({ onNavigate }: Props) {
  return (
    <>
      ...
      <div
        className="min-h-screen bg-[#010C15] text-white flex flex-col relative overflow-hidden"
        style={{
      ...
      >
        ...
        {/* ── Nav ──────────────────────────────────────────────────────────── */}
        <nav className="relative z-10 flex items-stretch border-b border-[#1E2D3D] text-sm">
          {/* Logo */}
          <div className="px-6 py-5 border-r border-[#1E2D3D] flex items-center">
            <span className="text-[#607B96]">kyle-allbright</span>
          </div>
        ...
        {/* ── Main ─────────────────────────────────────────────────────────── */}
        <main className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 px-8 md:px-12 lg:px-16 xl:px-24 py-14 lg:py-0">
          {/* Hero text */}
          <div className="flex-1 max-w-xl">
            <p className="text-[#607B96] text-sm mb-2">Hi all, I am</p>
            <h1 className="text-5xl sm:text-6xl font-bold text-white leading-[1.1] mb-5">
              Kyle Allbright
            </h1>
            <p className="text-[#43D9AD] text-lg lg:text-xl mb-12">
